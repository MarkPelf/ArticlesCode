...
using Example07.MockDatabase;
using System.Numerics;
using System.Linq;
using static System.Runtime.InteropServices.JavaScript.JSType;
using System.Diagnostics.Metrics;
using System.Linq.Dynamic.Core;
using Example07.Models.Home;
...
namespace Example07.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult EmployeeInfo(EmployeeInfoVM model)
        {
            return View(model);
        }

        public IActionResult EmployeeEdit(EmployeeEditVM model)
        {
            return View(model);
        }
